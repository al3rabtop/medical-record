...
export function RecordCard({ visit, linkedLabels = [] }: { visit: PortalVisit; linkedLabels?: string[] }) {
  ...
  const departmentLabel = visit.department ? (t.departmentLabels[visit.department] ?? visit.department) : null;
